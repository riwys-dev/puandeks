...
<head>
	...
	<title>Satış ve Fiyatlandırma - Puandeks</title>
...
<body class="bg_color_1">
    ...
    <!-- /header -->
      ...
      <div style="background-color:#f9f7f3; padding:40px 20px; text-align:center; margin-top:72px">
        <h1 style="font-size:32px; font-weight:600; margin:0; color:#000;">Satış ve Fiyatlandırma</h1>
        <p style="font-size:20px; color:#555; margin-top:8px;">Planlar, paketler ve fiyatlandırma ile ilgili destek alın.</p>
      </div>
   ...
   <!-- ==== SAYFA ALT ==== -->
    <div style="max-width:1000px; margin:0 auto;">
        ...
        <h2 style="font-size:24px; font-weight:600; margin-bottom:24px; color:#000;">
            Satış Ekibi ile İletişim
        </h2>

        <p style="font-size:16px; line-height:1.6; color:#444; margin-bottom:32px;">
            Paketler, fiyatlandırma, yükseltme ve teklif konularında bizimle iletişime geçmek için aşağıdaki formu kullanabilirsiniz.
        </p>
            ...
            <form id="salesForm"
                ...
                <div id="salesTopicDropdown"
                    ...
                    <ul id="salesTopicOptions"
                        ...
                        <li data-value="paket-sorusu" style="padding:12px; cursor:pointer;">Paketler hakkında soru</li>
                        <li data-value="fiyatlandirma" style="padding:12px; cursor:pointer;">Fiyatlandırma bilgisi</li>
                        <li data-value="kurumsal-teklif" style="padding:12px; cursor:pointer;">Kurumsal teklif talebi</li>
                        <li data-value="paket-yukseltme" style="padding:12px; cursor:pointer;">Paket yükseltme isteği</li>
                        <li data-value="indirim-sorusu" style="padding:12px; cursor:pointer;">İndirim / kampanya sorusu</li>
                        <li data-value="diger" style="padding:12px; cursor:pointer;">Diğer satış konusu</li>

                    </ul>

                    <input type="hidden" name="topic" id="salesTopicInput">
                </div>
                ...
                <textarea name="message"
                    ...
                    placeholder="Talebinizi detaylı şekilde açıklayın"></textarea>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const box = document.getElementById("salesTopicDropdown");
    const selected = document.getElementById("salesTopicSelected");
    const list = document.getElementById("salesTopicOptions");
    const input = document.getElementById("salesTopicInput");
...
document.getElementById("salesForm").addEventListener("submit", function(e) {
    ...
    const form = this;
    const topicValue = document.getElementById("salesTopicInput").value;
    ...
    .then(data => {
        ...
        if (data.status === "success") {
            ...
            form.reset();
            document.getElementById("salesTopicSelected").textContent = "Bir konu seçin";
            document.getElementById("salesTopicInput").value = "";
        } else {
            alert(data.message);
        }
